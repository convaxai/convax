...
- `packages/agent-runtime`: host-agnostic DeepSeek Harness integration, official
  Host ApiProxy projection, sessions, Skills, resources, and Host-tool bridge.
...
| Agent, DSH, Skill, Hook, Agent tool, protected path                                      | [`docs/architecture.md` §§7–8](docs/architecture.md#7-agent-tools-and-skills), [`docs/plugin-skill-platform.md`](docs/plugin-skill-platform.md), and [`packages/agent-runtime/AGENTS.md`](packages/agent-runtime/AGENTS.md)                                                          |
...
| `@convax/canvas`            | Canvas schema/core, reducers, typed intents, business/view operations, editor/plugin contracts, React Flow projection and transient gesture semantics                                                                       | Project paths/registry, Workbench selection, Agent runtime implementation, native persistence                       |
...
| `@convax/agent-runtime`     | Generic Agent contracts, closed DSH boot, official Host ApiProxy adapter/carrier, sessions, Skills, resources and tool-provider bridge                                                                                      | Convax Project/Canvas/UI policy, Electron process ownership, or imports from other Convax packages                  |
...
- Only `@convax/agent-runtime` may import `@deepseek-ai/*`. DSH process ownership
  and Project binding remain Desktop
...
- Convax integrates with exact-pinned published DSH packages only; do not copy or
  modify DSH source.
