...
try {
  ...
  console.log(
    `Desktop Settings, Canvas generation CAS/late-callback/restart races, installed Skill showcase/detail, Open Project, and 3D Plugin current-frame smoke passed (${summary.projectId}, canvas-main)`,
  )
} catch (error) {
  child.kill("SIGKILL")
