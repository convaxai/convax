...
if (!hasBuiltUiStyles && (!existsSync(sourceUiStylesPath) || !existsSync(sourceUiThemePath))) {
  throw new Error("@convax/ui must provide either compiled styles or source styles while building @convax/project")
}
...
console.log(`compiled package CSS: @convax/project (${styles.length} bytes)`)
