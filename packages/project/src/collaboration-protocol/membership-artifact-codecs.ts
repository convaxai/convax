...
function close<const Format extends string, const Domain extends `${string}/2`, const Core extends object>(source: { readonly coreDigest: unknown; readonly serviceSignature: unknown }, format: Format, domain: Domain, core: Core): Readonly<{ format: Format; core: Core; coreDigest: Digest; serviceSignature: ReturnType<typeof parseSignature> }> {
