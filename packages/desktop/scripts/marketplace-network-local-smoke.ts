...
async function main() {
  ...
  try {
    ...
    const pluginManifest =
      '{"schema":"convax.plugin/5","id":"local-smoke-plugin","name":"Local Smoke Plugin","description":"Local immutable Plugin snapshot","version":"1.0.0","capabilities":["projects.read"],"contributes":{}}\n'
    const skillMarkdown =
