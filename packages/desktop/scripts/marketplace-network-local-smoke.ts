...
async function main() {
  ...
  try {
    ...
    const pluginManifest =
      '{"schema":"convax.plugin/8","id":"local-smoke-plugin","name":"Local Smoke Plugin","description":"Local immutable Plugin snapshot","version":"1.0.0","hostApi":{"major":3,"required":["projects.list"],"optional":[]},"capabilities":["projects.read"],"contributes":{}}\n'
    const skillMarkdown =
