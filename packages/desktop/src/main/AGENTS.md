...
- Project file-tree previews use their own sender-scoped opaque lease protocol.
  ...
  Normal image/video row covers use these renderer-decoded thumbnail leases;
  bounded thumbnail IPC remains a compatibility fallback and never substitutes a
  complete media data URL.
