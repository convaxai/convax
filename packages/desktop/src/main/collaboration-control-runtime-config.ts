import { parseDigestV2, parsePublicKeyV2, type DigestV2 } from "@convax/collaboration"
...
export function parseDesktopCollaborationControlRuntimeConfigV1(
  ...
  const keys = source.keys.map((value) => {
    ...
    return Object.freeze({ purpose: key.purpose, serviceKeyId: key.serviceKeyId, publicKey: parsePublicKeyV2(key.publicKey) })
  })
  ...
  return Object.freeze({
    ...
    trustBundleDigest: parseDigestV2(source.trustBundleDigest),
