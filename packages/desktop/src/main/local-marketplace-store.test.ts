...
describe("LocalMarketplaceStore", () => {
  ...
  test.each([
    [
      "plugin",
      "manifest.json",
      '{"schema":"convax.plugin/8","id":"local-plugin","name":"Local Plugin","description":"Local plugin","version":"1.0.0","hostApi":{"major":2,"required":[],"optional":[]},"capabilities":["projects.read"],"contributes":{}}',
    ],
