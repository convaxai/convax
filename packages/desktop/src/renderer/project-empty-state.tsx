...
export function ProjectCollaborationPendingState({
  ...
  const copy = locale === "zh-CN"
    ? {
        ...
        copied: "已复制",
        createdDescription: "分享已启用。请先保存或发送这个一次性邀请，然后继续进入项目。",
        createdInvitation: "协同邀请",
    ...
    : {
        create: "Start sharing and enable collaboration",
        ...
        copied: "Copied",
        createdDescription: "Sharing is enabled. Save or send this one-time invitation before continuing to the Project.",
        createdInvitation: "Collaboration invitation",
        ...
        join: "Join collaboration with an invitation",
