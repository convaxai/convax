...
const englishMessages = {
  ...
  "capabilities.pluginsDescription":
    "Plugins add sandboxed Canvas experiences. Tool Plugins can also add generation and service tools; choosing Install or Import authorizes the exact declared, fingerprinted local executable. Companion Skills stay separate.",
  ...
  "capabilities.skillsDescription":
    "Skills are portable Agent workflows. Host-specific tools remain optional; managed Skills can be removed here and globally discovered Skills stay read-only.",
...
const chineseMessages = {
  ...
  "capabilities.pluginsDescription":
    "插件可增加沙箱化画布体验。工具插件还可提供生成与服务工具；选择“安装”或“导入”即授权其声明并经指纹校验的本地可执行文件。配套技能始终独立安装。",
  ...
  "capabilities.skillsDescription":
    "技能是可移植的 Agent 工作流。宿主专用工具始终是可选能力；可在这里移除由 Convax 管理的技能，全局发现的技能保持只读。",
